...
export const SCHEME_PRESETS: SchemePreset[] = [
  ...
  {
    id: 'csm-word-bearers', name: 'Word Bearers warband', category: 'Chaos Space Marines', source: 'Derived from Squidmar method',
  ...
  {
    id: 'csm-night-lords', name: 'Nemesis Claw · Night Lords', category: 'Chaos Space Marines', source: 'Derived from Squidmar method',
  ...
  {
    id: 'csm-black-legion', name: 'Black Legion strike force', category: 'Chaos Space Marines', source: 'Derived from Squidmar method',
...
export function instantiatePreset(preset: SchemePreset, paints: Paint[]): { scheme: Scheme; recipes: Recipe[]; paintIds: string[] } {
  ...
  return { scheme: { id: schemeId, slug: preset.id, name: preset.name, notes: `${preset.description} · ${preset.source}.`, createdAt, updatedAt: createdAt }, recipes, paintIds: [...refs] }
}
